  ...
  return (
    <main className="mt-5 d-flex flex-column align-items-center">
      ...
      <div className="d-grid gap-2 col-6 mx-auto">
        ...
        <button className="btn btn-warning" type='button' onClick={()=>{setOcultarPacientes(false);setOcultarForm(true);setOcultarLogin(true)}}>Mostrar Pacientes</button>
        <button className="btn btn-succes" type='button' onClick={()=>{setOcultarForm(false);setOcultarPacientes(true);setOcultarLogin(true)}}>Cargar Pacientes</button>
      </div>
